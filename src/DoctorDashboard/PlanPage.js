                        ...
                        <div className="mx-auto w-full p-5 lg:p-10 bg-white dark:bg-gray-800 shadow rounded">
                            ...
                            <div className="flex flex-col lg:flex-row items-start lg:items-center">
                                <div className="w-full lg:w-1/2 pr-0 lg:pr-48">
                                    ...
                                    <button className="bg-[#452a72] font-medium transition duration-150 ease-in-out hover:bg-transparent rounded text-white hover:text-[#452a72] px-6 py-2 text-sm border border-[#452a72] ] focus:outline-none">Upgrade Plan</button>
