                ...
                <div className="flex flex-no-wrap">
                    ...
                    <div className="absolute lg:relative w-64  h-screen shadow bg-gray-100 hidden lg:block" >
                        <div className="h-16 w-full flex items-center px-8">
                            ...
                            <img onClick={() => navigate("/")} className="cursor-pointer" src="https://bentlyfoundation.org/images/tesla.png" alt="brand" />
                        </div>
                        <ul aria-orientation="vertical" className=" py-6">
                            {props.userData.role === "doctor" ? (<>
                                ...
                                <li onClick={() => navigate("/doctor/quickNotes")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 pt-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div className="flex items-center">
                                        <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-pen"></i>
                                        <span className="ml-2">Notes</span>
                                    </div>
                                </li>
                                <li onClick={() => navigate("/doctor/questions")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div className="flex items-center">
                                        <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-question"></i>
                                        <span className="ml-2">Questions</span>
                                    </div>
                                </li>
                                <li onClick={() => navigate("/doctor/instagram")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-2 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div className="flex items-center">
                                ...
                                (
                                    <>
                                        ...
                                        <li onClick={() => navigate("/admin/questions")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-question"></i>
                                                <span className="ml-2">Asked Questions</span>
                                            </div>
                                        </li>
                                        {/* <li onClick={() => navigate("/admin/questions/replied")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-question"></i>
                                                <span className="ml-2">Replied Questions</span>
                                            </div>
                                        </li> */}
                                        <li onClick={() => navigate("/admin/instagram")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-2 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-brands fa-instagram"></i>
                                                <span className="ml-2">Instagram</span>
                                            </div>
                                        </li>
                                        <li onClick={() => navigate("/admin/quickNotes")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 pt-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-pen"></i>
                                                <span className="ml-2">Notes</span>
                                            </div>
                                ...
                                <>
                                    ...
                                    <li onClick={() => navigate("/patient/questions")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                        <div className="flex items-center">
                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-question"></i>
                                            <span className="ml-2">Questions</span>
                                        </div>
                                    </li>
                                    <li onClick={() => navigate("/patient/profile")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                        <div className="flex items-center">
                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-id-card"></i>
                                            <span className="ml-2">Profile</span>
                                        </div>
                                            ...
                                            <div className="rounded-full">
                                                {profile ? (
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        ...
                                                        <li className="flex w-full justify-between text-[#7963a7] hover:text-[#452a72] cursor-pointer items-center mt-2">
                                                            <div className="flex items-center">
