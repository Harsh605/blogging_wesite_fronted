      ...
      <nav className="flex justify-center">
        <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
          ...
          <div className="order-3 hidden w-full md:flex md:w-auto md:order-none md:justify-end">
            <Link className="px-5 py-2 text-sm font-medium text-gray-600 hover:text-[#452a72] " target="" rel="" to="/doctors">Doctors</Link>
            ...
            <Link className="px-5 py-2 text-sm font-medium text-gray-600 hover:text-[#452a72] " to={`/${userData.role}/dashboard`}>Dashboard</Link>
            <Link className="px-5 py-2 text-sm font-medium text-gray-600 hover:text-[#452a72] " to="/login">Login</Link>
          </div>
