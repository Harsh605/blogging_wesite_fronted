                  ...
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">Doctors</h5>
              ...
              <div class="w-full lg:w-6/12 xl:w-3/12 md:px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg">
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">Users</h5>
                        <span class=" text-xl">2,356</span>
                      </div>
                      <div class="relative w-auto pl-4 flex-initial">
              ...
              <div class="w-full lg:w-6/12 xl:w-3/12 md:px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg">
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">Meterial</h5>
                        <span class=" text-xl">2,356</span>
                      </div>
                      <div class="relative w-auto pl-4 flex-initial">
              ...
              <div class="w-full lg:w-6/12 xl:w-3/12 md:px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg">
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">SALES</h5>
                        <span class=" text-xl">9240$</span>
                      </div>
                      <div class="relative w-auto pl-4 flex-initial">
              ...
              <div class="w-full lg:w-6/12 xl:w-3/12 md:px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg">
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">Pending Users</h5>
                        <span class=" text-xl">924</span>
                      </div>
                      <div class="relative w-auto pl-4 flex-initial">
              ...
              <div class="w-full lg:w-6/12 xl:w-3/12 md:px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg">
                  <div class="flex-auto p-4">
                    <div class="flex flex-wrap">
                      <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                        <h5 class="text-blueGray-400 uppercase  text-xs">Pending blog</h5>
